...
MapThread[
  With[{\[Delta] = #2},
    Module[{data, tickGrid},
      tickGrid = {DateRange["2010", "2020", Quantity[2, #1]], Automatic};
      data = {#["Start"], #["End"], #["Summary"]} & /@ googleCalendar["EventList"];

      TimelinePlot[
        (Interval[{#[[1]], #[[2]]}] -> #[[3]] & /@ Select[data, #[[1]] > DatePlus[Today, -\[Delta]] &])
        ...
        GridLines -> tickGrid,
        Ticks -> tickGrid,
        PlotRange -> {{DatePlus[Today, -#2], DatePlus[Today, #2]}, Automatic}]
    ]
