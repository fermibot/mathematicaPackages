...
InBreed[firstGeneration_List, gen_ : 10, child_ : 10] := Nest[CreateChildren[#, child]&, firstGeneration, gen];
InBreedList[firstGeneration_List, gen_ : 10, child_ : 10] := NestList[CreateChildren[#, child]&, firstGeneration, gen];
